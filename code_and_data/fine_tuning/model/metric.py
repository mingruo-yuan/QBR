...
def precision_at_k(input_ranking, k=3, pos_score=1):
    """
...
def recall_at_k(input_ranking, k=3, pos_score=1, zero_division=0):
    """
...
def mean_average_precision(input_ranking, pos_score=1, zero_division=0):
    """
...
def mrr(input_ranking, pos_score=1, zero_division=0):
    """
